//
//  WNPDetailViewController.m
//  SinchCalling
//
//  Created by peng wan on 15-1-22.
//
//
...
@interface WNPCarDetailViewController ()<UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate, SINCallClientDelegate, SINMessageClientDelegate>
...
@implementation WNPCarDetailViewController
...
- (IBAction)makePhoneCallButtonTouchUpInside:(id)sender {
    ...
    if ([self.client isStarted]) {
        ...
        [self performSegueWithIdentifier:@"callView_car" sender:call];
    }    
}
...
- (IBAction)sendTextButtonTouchUpInside:(id)sender {
    ...
    if ([self.client isStarted]) {
        [self performSegueWithIdentifier:@"messageView_car" sender:nil];
    }
}
