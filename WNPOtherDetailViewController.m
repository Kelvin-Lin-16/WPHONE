//
//  WNPOtherDetailViewController.m
//  WNPhone
//
...
@interface WNPOtherDetailViewController () <UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate, SINCallClientDelegate>
...
@implementation WNPOtherDetailViewController
...
- (IBAction)makePhoneCallButtonTouchUpInside:(id)sender {
    ...
    if ([self.client isStarted]) {
        ...
        [self performSegueWithIdentifier:@"callView_other" sender:call];
    }
}
...
- (IBAction)sendTextButtonTouchUpInside:(id)sender {
    ...
    if ([self.client isStarted]) {
        [self performSegueWithIdentifier:@"messageView_other" sender:nil];
    }
}
